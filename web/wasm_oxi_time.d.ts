...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h48cd90017bf85e8c: (a: number, b: number, c: number, d: number) => void;
